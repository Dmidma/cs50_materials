<?php
    ...
    function sendMail($email, $msg)
    {
    	...
    	$mail->isSMTP();
    	$mail->Host = 'tls://smtp-mail.outlook.com:587';
    	$mail->SMTPAuth = true;
    	$mail->Username = 'dmidmacs50@outlook.com';
    	$mail->Password = 'abcde123';

    	$mail->setFrom('dmidmacs50@outlook.com', 'Dmidma@CS50Finance');
    	$mail->addAddress($email);
    	$mail->isHTML(true);			

    	$mail->Subject = 'Linking Email';
    	$mail->Body    = '<h1>Thank you for linking your email.</h1>' . '<b>' . $msg . '</b>';
